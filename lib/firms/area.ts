 ...
 *
 * Priority zone: Valle del Cauca — Sevilla, Caicedonia, Zarzal and
 * Roldanillo. The bounding box adds a margin around the four municipalities
 * so that fires on the surrounding cordillera slopes are captured.
 */
...
export const REFERENCE_POINTS = [
  ...
  { name: "Roldanillo", lat: 4.4126, lon: -76.1546 },
] as const
